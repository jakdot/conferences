"""
Model simulating data from Zajenkowski, Styla and Szymanik, 2011 - verification of proportional quantifiers by people suffering from schizophrenia.
"""
...
addition = actr.ACTRModel(subsymbolic=True, retrieval_threshold=-2.25, latency_factor=0.1, latency_exponent=0.5, instantaneous_noise = 0.25, decay=DECAY)
...
LEMMA_CHUNKS[actr.makechunk("", typename="add", arg1=numbers[11], arg2=numbers[4], sum=15)] = -4.5
LEMMA_CHUNKS[actr.makechunk("", typename="add", arg1=numbers[13], arg2=numbers[2], sum=15)] = -4.5 #to be found by simulation
...
for loop in range(100):
    ...
    sim = m.m.simulation(realtime=False, trace=False, gui=True, initial_time=init_time+2.0, environment_process=environ.environment_process, stimuli=stim_d, triggers='J', times=20)
    while True:
            try:
                sim.step()
            except simpy.core.EmptySchedule:
